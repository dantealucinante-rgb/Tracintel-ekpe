                    ...
                    <form onSubmit={handleSignIn} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <Link href="/forgot-password" avoided-is-internal-link className="text-[10px] font-bold uppercase tracking-wider text-black/40 hover:text-black transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative">
